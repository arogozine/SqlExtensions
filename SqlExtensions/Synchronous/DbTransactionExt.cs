...
namespace SqlExtensions
{
    public static class DbTransactionExt
    {
        ...
        public static IReadOnlyList<TOut> UsingCommand<TOut, TValue>(this DbTransaction tran, string query, Func<DbCommand, IReadOnlyList<TOut>> func, params (string name, TValue value)[] parameters)
        {
            return UsingCommand(tran, query, func, (IEnumerable<(string name, TValue value)>)parameters);
        }

        public static IReadOnlyList<TOut> UsingCommand<TOut, TValue>(this DbTransaction tran, string query, Func<DbCommand, IReadOnlyList<TOut>> func, IEnumerable<(string name, TValue value)> parameters)
        {
            using (var dbCommand = tran.Connection.CreateCommand())
            {
                dbCommand.Transaction = tran;
        ...
        public static void UsingCommand<TValue>(this DbTransaction tran, string query, Action<DbCommand> action, params (string name, TValue value)[] parameters)
        {
            UsingCommand(tran, query, action, (IEnumerable<(string name, TValue value)>)parameters);
        }

        public static void UsingCommand<TValue>(this DbTransaction tran, string query, Action<DbCommand> action, IEnumerable<(string name, TValue value)> parameters)
        {
            using (var dbCommand = tran.Connection.CreateCommand())
            {
                dbCommand.AddParameters(parameters);
        ...
        public static TOut UsingCommand<TOut, TValue>(this DbTransaction tran, string query, Func<DbCommand, TOut> func, params (string name, TValue value)[] parameters)
        {
            return UsingCommand(tran, query, func, (IEnumerable<(string name, TValue value)>)parameters);
        }

        public static TOut UsingCommand<TOut, TValue>(this DbTransaction tran, string query, Func<DbCommand, TOut> func, IEnumerable<(string name, TValue value)> parameters)
        {
            using (var dbCommand = tran.Connection.CreateCommand())
            {
                dbCommand.AddParameters(parameters);
        ...
        public static IReadOnlyList<TOut> QueryList<TOut, TValue>(this DbTransaction tran, string query, Func<DbCommand, IReadOnlyList<TOut>> func, params (string name, TValue value)[] parameters)
        {
            return UsingCommand(tran, query, func, (IEnumerable<(string name, TValue value)>)parameters);
        }

        public static IReadOnlyList<TOut> QueryList<TOut, TValue>(this DbTransaction tran, string query, Func<DbCommand, IReadOnlyList<TOut>> func, IEnumerable<(string name, TValue value)> parameters)
        {
            using (var dbCommand = tran.Connection.CreateCommand())
            {
                dbCommand.AddParameters(parameters);
        ...
        public static IReadOnlyList<TOut> QueryList<TOut, TValue>(this DbTransaction tran, string query, Func<IDataReader, IReadOnlyList<TOut>> func, params (string name, TValue value)[] parameters)
        {
            return QueryList(tran, query, func, (IEnumerable<(string name, TValue value)>)parameters);
        }

        public static IReadOnlyList<TOut> QueryList<TOut, TValue>(this DbTransaction tran, string query, Func<IDataReader, IReadOnlyList<TOut>> func, IEnumerable<(string name, TValue value)> parameters)
        {
            using (var dbCommand = tran.Connection.CreateCommand())
            {
                dbCommand.AddParameters(parameters);
        ...
        public static TOut QuerySingle<TOut, TValue>(this DbTransaction conn, string query, Func<DbCommand, TOut> func, params (string name, TValue value)[] parameters)
            => conn.UsingCommand(query, func, parameters);

        public static TOut QuerySingle<TOut, TValue>(this DbTransaction conn, string query, Func<DbCommand, TOut> func, IEnumerable<(string name, TValue value)> parameters)
            => conn.UsingCommand(query, func, parameters);
        ...
        public static TOut QuerySingle<TOut, TValue>(this DbTransaction conn, string query, Func<IDataReader, TOut> func, params (string name, TValue value)[] parameters)
            => conn.UsingCommand(query, cmd => cmd.QuerySingle(func), parameters);

        public static TOut QuerySingle<TOut, TValue>(this DbTransaction conn, string query, Func<IDataReader, TOut> func, IEnumerable<(string name, TValue value)> parameters)
            => conn.UsingCommand(query, cmd => cmd.QuerySingle(func), parameters);
        ...
        public static int NonQuery<TValue>(this DbTransaction tran, string sql, params (string name, TValue value)[] parameters)
            => tran.UsingCommand(sql, cmd => cmd.ExecuteNonQuery(), parameters);

        public static int NonQuery<TValue>(this DbTransaction tran, string sql, IEnumerable<(string name, TValue value)> parameters)
            => tran.UsingCommand(sql, cmd => cmd.ExecuteNonQuery(), parameters);
